...
import { CosmicJourney } from '../../world/cosmos/cosmic-journey';
...
export class UniverseEngine {
  ...
  readonly cosmicJourney = new CosmicJourney();
  ...
  constructor(canvas: HTMLCanvasElement) {
    ...
    this.sceneManager.add(this.cosmicJourney.group);
  ...
  stop(): void { cancelAnimationFrame(this.animationFrameId); }
