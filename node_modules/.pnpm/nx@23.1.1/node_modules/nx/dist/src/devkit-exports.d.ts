 ...
 * @category Workspace
 */
export type { ExpandedPluginConfiguration, ImplicitDependencyEntry, ImplicitJsonSubsetDependency, NxAffectedConfig, NxJsonConfiguration, PluginConfiguration, TargetDefaults, TargetDefaultEntry, TargetDefaultValue, TargetDefaultArrayEntry, TargetDefaultFilter, } from './config/nx-json';
/**
 * @category Logger
 */
