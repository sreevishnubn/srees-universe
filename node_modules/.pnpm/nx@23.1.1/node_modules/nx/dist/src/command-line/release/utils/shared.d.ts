...
export declare function getCommitsRelevantToProjects(projectGraph: ProjectGraph, commits: GitCommit[], projects: string[], nxReleaseConfig: NxReleaseConfig, releaseGraph: ReleaseGraph, releaseGroupProjects?: string[]): Promise<Map<string, {
    commit: GitCommit;
