...
export declare function resolveSemverSpecifierFromConventionalCommits(from: string, projectGraph: ProjectGraph, projectNames: string[], releaseConfig: NxReleaseConfig, releaseGraph: ReleaseGraph, releaseGroupProjects?: string[]): Promise<Map<string, SemverSpecifier | null>>;
