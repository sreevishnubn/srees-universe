...
async function createProjectGraphAndSourceMapsAsync(opts = {
    ...
    perf_hooks_1.performance.mark('createProjectGraphAsync:start');
    ...
    if ((0, is_on_daemon_1.isOnDaemon)()) {
        const { currentProjectGraph, currentSourceMaps } = await (0, handle_import_1.handleImport)('../daemon/server/project-graph-incremental-recomputation.js', __dirname);
        if (currentProjectGraph) {
            perf_hooks_1.performance.mark('createProjectGraphAsync:end');
            perf_hooks_1.performance.measure('createProjectGraphAsync', {
    ...
    if (!client_1.daemonClient.enabled()) {
        ...
        try {
            ...
            perf_hooks_1.performance.measure('createProjectGraphAsync >> retrieve-project-configurations', 'retrieve-project-configurations:start', 'retrieve-project-configurations:end');
            perf_hooks_1.performance.measure('createProjectGraphAsync >> retrieve-workspace-files', 'retrieve-workspace-files:start', 'retrieve-workspace-files:end');
            perf_hooks_1.performance.measure('createProjectGraphAsync >> build-project-graph-using-project-file-map', 'build-project-graph-using-project-file-map:start', 'build-project-graph-using-project-file-map:end');
            perf_hooks_1.performance.mark('createProjectGraphAsync:end');
            perf_hooks_1.performance.measure('createProjectGraphAsync', {
                start: 'createProjectGraphAsync:start',
                end: 'createProjectGraphAsync:end',
