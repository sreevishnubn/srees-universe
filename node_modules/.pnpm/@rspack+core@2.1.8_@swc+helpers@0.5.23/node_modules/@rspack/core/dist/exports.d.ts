...
import { CssChunkingPlugin, LimitChunkCountPlugin, RealContentHashPlugin, RemoveDuplicateModulesPlugin, RsdoctorPlugin, RslibPlugin, RstestPlugin, RuntimeChunkPlugin, SplitChunksPlugin } from './builtin-plugin/index.js';
interface Optimize {
