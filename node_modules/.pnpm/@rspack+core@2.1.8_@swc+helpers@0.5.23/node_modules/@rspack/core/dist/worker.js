...
import { __webpack_require__ } from "./612~3.js";
...
let binding_namespaceObject = __rspack_createRequire_require(process.env.RSPACK_BINDING || "@rspack/binding");
...
function loadLoader(loader, compiler, callback) {
    ...
    if ('module' === loader.type) try {
        ...
        if (void 0 === modulePromise) {
            void 0 === url && (url = __webpack_require__("node:url"));
