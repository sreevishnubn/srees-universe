...
function getPresetDependencies({ preset, presetVersion, bundler, e2eTestRunner, js, }) {
    switch (preset) {
        ...
        case presets_1.Preset.TsStandalone:
            return {
                ...
                dev: {
                    ...
                    typescript: js ? undefined : versions_1.typescriptVersion,
                },
            };
        ...
        case presets_1.Preset.Express:
            return {
                dependencies: {},
                dev: { '@nx/express': versions_1.nxVersion, typescript: versions_1.typescriptVersion },
            };
        ...
        case presets_1.Preset.NextJsStandalone:
            return {
                dependencies: { '@nx/next': versions_1.nxVersion },
                dev: { typescript: versions_1.typescriptVersion },
            };
        ...
        case presets_1.Preset.ReactNative:
            return {
                dependencies: {},
                dev: { '@nx/react-native': versions_1.nxVersion, typescript: versions_1.typescriptVersion },
            };
        case presets_1.Preset.Expo:
            return {
                dependencies: {},
                dev: { '@nx/expo': versions_1.nxVersion, typescript: versions_1.typescriptVersion },
            };
